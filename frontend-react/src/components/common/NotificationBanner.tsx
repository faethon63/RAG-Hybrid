...
export function NotificationBanner() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl shadow-lg px-5 py-3 flex items-center gap-4 max-w-md">
